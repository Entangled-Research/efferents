...
Run the commands below from the repository root after installing efferents.
For installation, start with the [offline demo](#try-it-offline-60-seconds-no-api-key).
